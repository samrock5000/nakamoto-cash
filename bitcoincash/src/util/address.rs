...
impl fmt::Display for Address {
    fn fmt(&self, fmt: &mut fmt::Formatter) -> fmt::Result {
        let p2pkh_prefix = match self.network {
            ...
            Network::Testnet | Network::Testnet4 | Network::Scalenet | Network::Chipnet | Network::Regtest => PUBKEY_ADDRESS_PREFIX_TEST,
        };
        let p2sh_prefix = match self.network {
            Network::Bitcoin => SCRIPT_ADDRESS_PREFIX_MAIN,
            Network::Testnet | Network::Testnet4 | Network::Scalenet | Network::Chipnet | Network::Regtest => SCRIPT_ADDRESS_PREFIX_TEST,
        };
        let bech32_hrp = match self.network {
            Network::Bitcoin => "bc",
            Network::Testnet | Network::Testnet4 | Network::Scalenet | Network::Chipnet => "tb",
...
mod tests {
    ...
    fn test_valid_networks() {
        ...
        const LEGACY_EQUIVALENCE_CLASSES: &[&[Network]] = &[
            &[Network::Bitcoin],
            &[Network::Testnet, Network::Regtest, Network::Scalenet, Network::Chipnet],
        ];
        const SEGWIT_EQUIVALENCE_CLASSES: &[&[Network]] = &[
            &[Network::Bitcoin],
            &[Network::Regtest],
            &[Network::Testnet, Network::Scalenet, Network::Chipnet],
        ];
