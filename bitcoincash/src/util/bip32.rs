...
impl ExtendedPrivKey {
    ...
    pub fn encode(&self) -> [u8; 78] {
        ...
        ret[0..4].copy_from_slice(&match self.network {
            ...
            Network::Testnet | Network::Testnet4 | Network::Scalenet | Network::Chipnet | Network::Regtest => [0x04, 0x35, 0x83, 0x94],
        }[..]);
...
impl ExtendedPubKey {
    ...
    pub fn encode(&self) -> [u8; 78] {
        ...
        ret[0..4].copy_from_slice(&match self.network {
            ...
            Network::Testnet | Network::Testnet4 | Network::Scalenet | Network::Chipnet | Network::Regtest => [0x04u8, 0x35, 0x87, 0xCF],
        }[..]);
        ret[4] = self.depth as u8;
        ret[5..9].copy_from_slice(&self.parent_fingerprint[..]);
        ret[9..13].copy_from_slice(&endian::u32_to_array_be(u32::from(self.child_number)));
