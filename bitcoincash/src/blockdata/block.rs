...
impl BlockHeader {
    ...
    pub fn target(&self) -> Uint256 {
        Self::u256_from_compact_target(self.bits.to_consensus())
    }
    ...
    /// TODO configure new API get_difficulty
    pub fn get_difficulty(&self, network: Network) -> u128 {
        self.get_target().difficulty(network)
    }
    ...
    /// Checks that the proof-of-work for the block is valid, returning the block hash.
    pub fn validate_pow2(&self, required_target: Target) -> Result<BlockHash, util::Error> {
