...
/// # Examples
/// ```
/// # use bitcoincash::{Amount, PackedLockTime, LockTime};
...
/// # Examples
/// ```
/// # use bitcoincash::{LockTime, LockTime::*};
...
impl LockTime {
    ...
    /// # Examples
    /// ```no_run
    /// # use bitcoincash::blockdata::locktime::{LockTime, Height, Time};
...
impl Height {
    ...
    /// # Examples
    /// ```rust
    /// use bitcoincash::blockdata::locktime::Height;
    ///
    /// let h: u32 = 741521;
...
impl Time {
    ...
    /// # Examples
    /// ```rust
    /// use bitcoincash::blockdata::locktime::Time;
    ///
