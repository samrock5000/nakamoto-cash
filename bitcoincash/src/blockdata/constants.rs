...
/// 1MB
pub const ONE_MEGABYTE: u32 = 1000000;
...
pub const MAX_BLOCK_WEIGHT: u32 = 32 * ONE_MEGABYTE;
/// The minimum transaction weight for a valid serialized transaction
pub const MIN_TRANSACTION_WEIGHT: u32 = 65;
...
fn bitcoin_genesis_tx() -> Transaction {
    ...
    let out_script = script::Builder::new()
        ...
        .into_script();
    ret.output.push(TxOut { value: 50 * COIN_VALUE, script_pubkey: out_script, token: None });
...
impl ChainHash {
    ...
    pub fn using_genesis_block(network: Network) -> Self {
        match network {
            ...
            Network::Testnet4 | Network::Scalenet | Network::Chipnet => todo!(),
        }
    }
}
