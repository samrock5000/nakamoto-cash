...
pub mod all {
    ...
    /// Check if signature is valid for message and public key.
    pub const OP_CHECKDATASIG: All = All {code: 0xba};
    /// Same as OP_CHECKDATASIG, but runs OP_VERIFY after.
    pub const OP_CHECKDATASIGVERIFY: All = All {code: 0xbb};
    /// Reverses the order of the bytes in byte sequence x so that the first byte is not the last
    /// byte, second is now the second to last and so forth.
    pub const OP_REVERSEBYTES: All = All {code: 0xbc};
    /// Synonym for OP_RETURN.
    ...
    /// Push the index of the input being evaluated to the stack as Script Number.
    pub const OP_INPUTINDEX: All = All {code: 0xc0};
    ...
    pub const OP_UTXOVALUE: All = All {code: 0xc6};
    ...
    pub const OP_UTXOBYTECODE: All = All {code: 0xc7};
    ...
    pub const OP_OUTPOINTTXHASH: All = All {code: 0xc8};
    ...
    pub const OP_OUTPOINTINDEX: All = All {code: 0xc9};
    ...
    pub const OP_INPUTBYTECODE: All = All {code: 0xca};
    ...
    pub const OP_INPUTSEQUENCENUMBER: All = All {code: 0xcb};
    ...
    pub const OP_OUTPUTVALUE: All = All {code: 0xcc};
    ...
    pub const OP_OUTPUTBYTECODE: All = All {code: 0xcd};
    /// Synonym for OP_RETURN.
    ...
    /// CashTokens prefix
    pub const OP_SPECIAL_TOKEN_PREFIX: All = All {code: 0xef};
}
...
impl fmt::Debug for All {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        match *self {
            ...
            all::OP_SPLIT => write!(f, "SPLIT"),
            all::OP_NUM2BIN => write!(f, "NUM2BIN"),
            all::OP_BIN2NUM => write!(f, "BIN2NUM"),
            ...
            all::OP_CHECKDATASIG => write!(f, "CHECKDATASIG"),
            all::OP_CHECKDATASIGVERIFY => write!(f, "CHECKDATASIGVERIFY"),
            all::OP_REVERSEBYTES => write!(f, "REVERSEBYTES"),
            all::OP_INPUTINDEX => write!(f, "INPUTINDEX"),
            all::OP_ACTIVEBYTECODE => write!(f, "ACTIVEBYTECODE"),
            all::OP_TXVERSION => write!(f, "TXVERSION"),
            all::OP_TXINPUTCOUNT => write!(f, "TXINPUTCOUNT"),
            all::OP_TXOUTPUTCOUNT => write!(f, "TXOUTPUTCOUNT"),
            all::OP_TXLOCKTIME => write!(f, "TXLOCKTIME"),
            all::OP_UTXOVALUE => write!(f, "UTXOVALUE"),
            all::OP_UTXOBYTECODE => write!(f, "UTXOBYTECODE"),
            all::OP_OUTPOINTTXHASH => write!(f, "OUTPOINTTXHASH"),
            all::OP_OUTPOINTINDEX => write!(f, "OUTPOINTINDEX"),
            all::OP_INPUTBYTECODE => write!(f, "INPUTBYTECODE"),
            all::OP_INPUTSEQUENCENUMBER => write!(f, "INPUTSEQUENCENUMBER"),
            all::OP_OUTPUTVALUE => write!(f, "OUTPUTVALUE"),
            all::OP_OUTPUTBYTECODE => write!(f, "OUTPUTBYTECODE"),
            all::OP_SPECIAL_TOKEN_PREFIX => write!(f, "SPECIAL_TOKEN_PREFIX"),
