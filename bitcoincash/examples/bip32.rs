...
use bitcoincash::secp256k1::ffi::types::AlignedType;
use bitcoincash::secp256k1::Secp256k1;
use bitcoincash::util::address::Address;
use bitcoincash::util::bip32::{ChildNumber, DerivationPath, ExtendedPrivKey, ExtendedPubKey};
...
fn main() {
    ...
    let network = bitcoincash::Network::Bitcoin;
